...
<header className="text-center">
  <h1 className="text-2xl md:text-5xl font-semibold">Start je segment</h1>
  <p className="mt-2 text-sm text-muted-foreground">Geef je wensen op en laat AI je prospectlijst genereren.</p>
</header>
